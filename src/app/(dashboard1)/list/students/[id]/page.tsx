    ...
    <div className="mt-16 flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <h1 className="text-xl font-semibold">Hamza</h1>
        ...
        <div className="mt-4 bg-white rounded-md p-4 h-auto">
           <h1 className = "font-semibold text-lg">Student&apos;s Schedual</h1>
        <BigCalendar/>
        </div>
      ...
      <div className="bg-white p-4 rounded-md">
        ...
        <div className="mt-4 flex gap-2 flex-wrap text-xs text-gray-500 ">
          <Link className="p-2 rounded-md bg-lamaSkylight" href = "/">Student&apos;s Results</Link>
          <Link className="p-2 rounded-md bg-lamaPurplelight" href = "/">Student&apos;s Teachers</Link>
          <Link className="p-2 rounded-md bg-lamaYellowLight" href = "/">Student&apos;s Lessons</Link>
          <Link  className="p-2 rounded-md bg-pink-50" href = "/">Student&apos;s Exams</Link>
          <Link className="p-2 rounded-md bg-yellow-50" href = "/">Student&apos;s Assignments</Link>
